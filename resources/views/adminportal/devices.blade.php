...
<head>
  ...
  <title> Smart IMS | Admin Dashboard </title>
    ...
    <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
      ...
      <li class="nav-item">
        <a class="nav-link p-3">
          ...
          <span class="badge badge-success badge-notif">1</span>
        </a>
      </li>
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/view-records">
                <i class="fa fa-desktop"></i> Cooperatives
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/view-managers">
                <i class="fa fa-desktop"></i> Coop Managers
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/view-agronomists">
                <i class="fa fa-desktop"></i>Agronomists
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/view-analytics">
                <i class="fa fa-desktop"></i> Analytics
              </a>
            </li>
...
<center>
        <div class="card shadow mb-4">
          ...
          <tr>
            ...
            <td>{{ $device->dev_holder}}</td>
            <td>{{$device->dev_district}}</td>
            <td>{{ $device->dev_sector}}</td>
            <td>{{$device->dev_cell}}</td>
            <td>{{ $device->dev_village}}</td>
            <td>{{ $device->cooperatives_id}}</td>
            

            <td><a href = 'editdevice/{{ $device->id}}' style="color: white"> <button type="button" class="btn btn-primary"><i class="fa fa-pencil"></i>update</button> </a></td>
            <td>   
            <a href = 'deletedevice/{{ $device->id }}'><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i>Delete</button> </a></td>
                ...
                <div class="modal-body py-0">
                  ...
                  <div class="d-flex main-content">
                    ...
                    <div class="content-text p-4">
                      ...
                      <form action="{{ url('adddevices') }}" method="POST">
                        @csrf
                        <div class="form-group">
                          <label for="dev_name"> Devices No</label>
                          <input type="text" class="form-control" id="dev_name"  name="dev_id">
                        </div>

                        <div class="form-group">
                          <label for="dev_name"> Devices Name</label>
                          <input type="text" class="form-control" id="dev_name"  name="dev_name">
                        </div>
                        <div class="form-group">
                          <label for="dev_holder"> Holder</label>
                          <input type="text" class="form-control" id="dev_holder"  name="dev_holder">
                        </div>  <div class="form-group">
                          <label for="dev_district"> District</label>
                          <input type="text" class="form-control" id="dev_district"  name="dev_district">
                        </div>  <div class="form-group">
                          <label for="dev_sector"> Sector</label>
                          <input type="text" class="form-control" id="dev_sector"  name="dev_sector">
                        </div>  <div class="form-group">
                          <label for="dev_cell"> Cell</label>
                          <input type="text" class="form-control" id="dev_cell"  name="dev_cell">
                        </div>  <div class="form-group">
                          <label for="dev_village"> Village</label>
                          <input type="text" class="form-control" id="dev_village"  name="dev_village">
                        </div>
                        </div>  <div class="form-group">
                          <label for="dev_village"> Holder Id</label>
